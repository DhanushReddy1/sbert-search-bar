...
if __name__ == "__main__":
    ...
    # In case you don't want to use Mongo DB, you can directly read data

    #abbreviations_df = pd.read_excel("data/Abbreviations.xlsx")
    #project_topics_df = pd.read_csv("data/project_topics.csv")
    #project_description_df = pd.read_csv("data/project_description.csv")
